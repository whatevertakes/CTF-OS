...
def test_live_ro_writes_network_timeout_and_cleanup(tmp_path: Path) -> None:
    ...
    spec = SandboxSpec("demo", "live123", "live", source, branch, image="ctf-os-sandbox:refactor-check")
    ...
    timeout_meta = create(SandboxSpec("demo", "live123", "timeout", source, timeout_branch, image="ctf-os-sandbox:refactor-check"))
