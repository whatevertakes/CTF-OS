...
description: Prepare an exact-run, operator-started Claude rescue workspace without launching Claude. Use for “Claude 구조대 준비해라”, “클로드 구조대 준비해라”, “Claude에게 넘길 준비해라”, “구조대 폴더 만들어라”, or “딥 Claude 구조대 준비해라”.
---
...
7. Use `standard` unless the operator explicitly requested deep/Fable. An explicit deep request uses `deep`; do not infer it from elapsed time or difficulty.
