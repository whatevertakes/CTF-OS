...
Publish `EXPLOIT_PRIMITIVE` or `WORKING_POC` immediately, run the minimal exploit on the declared remote, preserve the exact output and exploit artifact, and surface a matching flag without waiting for clean replay.
