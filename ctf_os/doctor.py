...
def run_doctor(repo: Path) -> dict[str, object]:
    ...
    add("first-to-flag-runtime", importlib.util.find_spec("ctf_os.swarm") is not None, "ctf_os.swarm", "restore the first-to-flag swarm runtime")
    try:
    ...
    # active swarm sandboxes and exact-label service lifecycles are not stale.
