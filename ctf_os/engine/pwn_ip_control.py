...
PWN_IP_CONTROL_LEGACY_MANAGED_CONTRACT_VERSION = 1
PWN_IP_CONTROL_LEGACY_TIMEOUT_SECONDS = 30
PWN_IP_CONTROL_MANAGED_CONTRACT_VERSION = 2
# Aggregate budget for one exact-image capability inspection followed by the
# three serial clean replays registered under managed contract v2.
PWN_IP_CONTROL_TIMEOUT_SECONDS = 90
