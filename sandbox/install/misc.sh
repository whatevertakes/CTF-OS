...
for command in ffmpeg sox convert tesseract tshark binwalk exiftool dot parallel podman zbarimg barcode php lua perl node npm; do require_command "$command"; done
