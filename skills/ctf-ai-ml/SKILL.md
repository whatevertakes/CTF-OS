...
- Optional garak and Damn Vulnerable LLM Agent references.
reference_digest:
...
- Use garak only for scoped model behavior probes where the target model,
  generator, and probe set are authorized and reproducible.
...
- `garak --help` before selecting a scoped generator and probe set.
