...
| `pwn` | `gcc`, `gdb`, `python3`, `pwntools`, `checksec`, `ROPgadget`, `ropper`, `pwninit` | `pwndbg-gdb`, `one_gadget`, `seccomp-tools`, `patchelf`, `qemu-x86_64`, `qemu-aarch64`, `qemu-system-x86_64`, `qemu-system-arm`, `qemu-system-aarch64`, `valgrind`, `afl-fuzz`, `honggfuzz`, `radamsa`, `gef-gdb`, `peda-gdb`, `heaptrack`, `keystone-as`. |
| `rev` | `file`, `strings`, `objdump`, `r2`, `angr`, `floss` | `ghidra-check`, `capa`, `rizin`, `cutter`, `rz-ghidra`, `r2ghidra`, `cfr`, `procyon`, `dotnet`, `ilspycmd`, `dnspy`, `monodis`, `emcc`, `llvm-objdump`, `yara`, `upx`, `qemu-x86_64`, `qemu-aarch64`, `qemu-system-x86_64`, `qemu-system-arm`, `qemu-system-aarch64`. |
