...
DEEP_CATEGORY_COMMANDS = {
    ...
    "forensics": (
        ...
        ("zeek", ("zeek", "--version")),
        ("NetworkMiner", ("NetworkMiner", "--version")),
        ("pdfid", ("pdfid.py", "-h")),
        ("pdf-parser", ("pdf-parser.py", "-h")),
        ("oledump", ("oledump.py", "-h")),
        ("outguess", ("outguess", "-h")),
        ("exiv2", ("exiv2", "--version")),
    ...
    "pwn": (
        ...
        ("peda-gdb", ("peda-gdb", "--batch", "-ex", "pi print('peda-gdb')")),
        ("heaptrack", ("heaptrack", "--version")),
        ("keystone-as", ("keystone-as", "--help")),
    ...
    "rev": (
        ...
        ("rz-ghidra", ("rz-ghidra", "--help")),
        ("r2ghidra", ("r2ghidra", "--help")),
        ("cfr", ("cfr", "--version")),
