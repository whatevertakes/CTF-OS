...
CATEGORY_DEFAULT_STRATEGIES: dict[str, dict[str, list[str]]] = {
    ...
    "pwn": {
        ...
        "tools": ["checksec", "gdb", "pwntools", "ROPgadget", "ropper", "one_gadget", "seccomp-tools", "pwninit", "Docker"],
    ...
    "stego": {
        ...
        "tools": ["file", "sha256sum", "exiftool", "binwalk", "zsteg", "stegolsb", "python"],
    ...
    "web3": {
        ...
        "tools": ["forge", "cast", "anvil", "slither", "python/web3", "transaction logs", "local fork"],
    ...
    "cloud": {
        ...
        "tools": ["local config parsers", "provider CLI only in owned scope", "jq/yq", "trivy/syft/grype for scoped images", "crane/skopeo for scoped registries", "logs"],
    ...
    "container": {
        ...
        "tools": ["docker", "tar", "jq/yq", "find", "capsh when installed", "trivy", "syft", "grype", "crane", "skopeo"],
