...
CATEGORY_DEFAULT_STRATEGIES: dict[str, dict[str, list[str]]] = {
    ...
    "pwn": {
        ...
        "tools": ["checksec", "gdb", "pwntools", "ROPgadget", "ropper", "one_gadget", "seccomp-tools", "pwninit", "patchelf", "qemu-user", "Docker"],
    ...
    "rev": {
        ...
        "tools": [".codex/bin/r2", ".codex/bin/angr-mcp", "floss", "yara/upx", "qemu-user", "gdb/ltrace/strace", "python solver"],
    ...
    "forensics": {
        ...
        "tools": ["file", "sha256sum", "binwalk", "foremost/photorec when installed", "tshark", "vol/Volatility3", "floss", "zsteg/stegolsb", "yara/upx", "strings"],
    ...
    "stego": {
        ...
        "tools": ["file", "sha256sum", "exiftool", "binwalk", "steghide", "zsteg", "stegolsb", "python"],
    ...
    "mobile": {
        ...
        "tools": ["jadx", "apktool", "frida/frida-ps", "strings", "python", "traffic transcripts"],
    ...
    "web3": {
        ...
        "tools": ["forge", "cast", "anvil", "chisel", "solc", "slither", "python/web3", "transaction logs", "local fork"],
