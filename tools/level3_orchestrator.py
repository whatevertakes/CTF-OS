...
CATEGORY_DEFAULT_STRATEGIES: dict[str, dict[str, list[str]]] = {
    "web": {
        ...
        "tools": [
            "curl/httpie",
            "python requests",
            "browser/playwright when UI state matters",
            "arjun after route baseline",
            "flask-unsign for evidenced Flask cookies",
            "wafw00f when filtering changes probe meaning",
            "shodan only for scoped public challenge targets",
            "sqlmap only after a concrete SQLi hypothesis exists",
            "ffuf/gobuster after route and wordlist scope are bounded",
            "Burp/Caido optional external proxy",
            "saved HTTP transcripts",
        ],
    ...
    "pwn": {
        ...
        "tools": ["checksec", "gdb", "pwndbg-gdb", "pwntools", "ROPgadget", "ropper", "one_gadget", "seccomp-tools", "pwninit", "patchelf", "qemu-user", "Docker"],
    ...
    "rev": {
        ...
        "tools": [".codex/bin/r2", ".codex/bin/angr-mcp", "ghidra/ghidra-analyzeHeadless", "floss", "yara/upx", "qemu-user", "gdb/ltrace/strace", "python solver"],
    ...
    "crypto": {
        ...
        "tools": ["RsaCtfTool", "sage", "python", "z3", "fplll", "pari-gp/gp", "transcript logs"],
    ...
    "forensics": {
        ...
        "tools": ["file", "sha256sum", "binwalk", "foremost/photorec when installed", "Sleuth Kit fls/mmls", "tshark", "vol/Volatility3", "floss", "zsteg/stegolsb", "yara/upx", "strings"],
    ...
    "stego": {
        ...
        "tools": ["file", "sha256sum", "exiftool", "binwalk", "steghide/stegseek", "zsteg", "stegolsb", "python"],
    ...
    "mobile": {
        ...
        "tools": ["jadx", "apktool", "adb", "objection", "frida/frida-ps", "strings", "python", "traffic transcripts"],
    ...
    "malware": {
        ...
        "tools": ["file", "sha256sum", "strings", "floss", "yara", "upx", ".codex/bin/r2", ".codex/bin/angr-mcp", "vol/Volatility3", "tshark"],
    ...
    "web3": {
        ...
        "tools": ["forge", "cast", "anvil", "chisel", "solc", "slither", "halmos", "python/web3", "transaction logs", "local fork"],
    ...
    "cloud": {
        ...
        "tools": ["local config parsers", "provider CLI only in owned scope", "kubectl only for owned clusters", "jq/yq", "trivy/syft/grype for scoped images", "crane/skopeo for scoped registries", "logs"],
    ...
    "container": {
        ...
        "tools": ["docker", "kubectl", "tar", "jq/yq", "find", "capsh when installed", "trivy", "syft", "grype", "crane", "skopeo"],
    ...
    "ai-ml": {
        ...
        "tools": ["prompt transcript", "python", "garak when scoped", "browser/playwright when UI state matters", "sanitized logs"],
    ...
    "side-channel": {
        ...
        "tools": ["python/numpy", "gnuradio when signal traces require it", "sage when math requires it", "plots when useful", "oracle transcripts"],
...
WORKER_STRATEGY_OVERRIDES: dict[str, dict[str, dict[str, list[str]]]] = {
    "web": {
        "auth_session": {
            ...
            "tools": ["curl/httpie", "python requests.Session", "flask-unsign for evidenced Flask cookies", "jwt tooling if present", "browser/playwright for UI-only flows", "Burp/Caido optional external proxy"],
        ...
        "source_disclosure": {
            ...
            "tools": ["curl", "python payload encoder", "arjun after route baseline", "wafw00f when filtering matters", "xxe/local file probes", "saved responses"],
        ...
        "policy_oracle": {
            ...
            "tools": ["python requests", "arjun for parameter inventory after baseline", "diff saved responses", "timing loop only after stable baseline"],
        ...
        "state_mutation": {
            ...
            "tools": ["curl/httpie", "python requests", f"work/{MUTATION_LEDGER}", "Burp/Caido optional external proxy", "saved JSON"],
        ...
        "render_runtime": {
            ...
            "tools": ["browser/playwright", "curl multipart", "Burp/Caido optional external proxy", "local renderer reproduction when possible"],
        ...
        "ssrf_internal": {
            ...
            "tools": ["interactsh-like callback if available", "local listener", "curl", "shodan only for scoped public target context", "saved fetch logs"],
    ...
    "pwn": {
        ...
        "crash_triage": {
            ...
            "tools": ["gdb", "pwndbg/gef if installed", "cyclic/cyclic_find", "ROPgadget/ropper after control evidence", "core files"],
    ...
    "rev": {
        "symbolic": {
            ...
            "tools": [".codex/bin/angr-mcp", "z3", "python", ".codex/bin/r2"],
    ...
    "crypto": {
        "oracle_model": {
            ...
            "tools": ["python requests/socket", "statistical timing script", "z3/fplll/Sage only when oracle math requires it", "transcript JSONL"],
    ...
    "forensics": {
        "memory_network": {
            ...
            "tools": ["tshark", "vol/Volatility3", "strings", "floss", "yara/upx", "grep/rg", "sha256sum"],
